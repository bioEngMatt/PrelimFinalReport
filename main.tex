...
\begin{figure}[h]
    \begin{subfigure}{0.5\textwidth}
        \includegraphics[width=0.9\linewidth, height=6cm,keepaspectratio,center]{exampleImg.png} 
        \caption{Image example}
        \label{fig:vj:exm}
    \end{subfigure}
    \begin{subfigure}{0.5\textwidth}
        \includegraphics[width=0.9\linewidth, height=6cm,center,keepaspectratio]{IntegralImg.png}
