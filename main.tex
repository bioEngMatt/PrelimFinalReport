...
\begin{figure}[h]
    \begin{subfigure}{0.5\textwidth}
        \includegraphics[width=0.9\linewidth, height=6cm,keepaspectratio,center]{Robotic_Arm_segments.pdf} 
    \end{subfigure}
    \begin{subfigure}{0.5\textwidth}
        \includegraphics[width=0.9\linewidth, height=6cm,keepaspectratio,center]{Robotic_rotationBase.pdf} 
    \end{subfigure}
